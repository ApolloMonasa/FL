...
### 风险提示与免责声明
- 仅供学习交流：本项目及相关代码仅供个人学习、研究 Android 逆向工程与安全防御机制使用，请于下载测试后 24 小时内自觉删除。

- 严禁违规用途：请勿将本模块用于校园跑软件、企业签到打卡、网约车抢单、LBS 游戏作弊等任何违规、违法或损害他人利益的场景。 - 责任归属：若因滥用本模块导致目标应用账号封禁、引发法律纠纷或造成任何形式的经济/权益损失，Fakelocation 原作者及受损方有权向您追究责任。本模块作者概不负责。

- 设备风险：Xposed/LSPosed 模块对系统底层的修改具有一定风险，可能会引起应用闪退、系统软重启（Soft Reboot）或卡开机动画（Bootloop）。请确保您具备基本的“救砖”能力（如通过 ADB 或 Recovery 禁用模块）。
